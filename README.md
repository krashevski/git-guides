...
- [REPOSITORY_STANDARDS_RU.md](docs/REPOSITORY_STANDARDS_RU.md) — стандарты работы с репозиторием.  
- [BRANCHING_STRATEGY.md](docs/BRANCHING_STRATEGY.md) — рекомендации по ветвлению.  
- [COMMIT_GUIDELINES.md](docs/COMMIT_GUIDELINES.md) — правила написания коммитов.  
- [PULL_REQUEST_PROCESS.md](docs/PULL_REQUEST_PROCESS.md) — процесс работы с pull request.  
