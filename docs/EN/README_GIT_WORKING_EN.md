...
- [REPOSITORY_STANDARDS_EN.md](README_REPOSITORY_STANDARDS_EN.md) — Repository working standards.
- [BRANCHING_STRATEGY_EN.md](BRANCHING_STRATEGY_EN.md) *(planned)* — Branching guidelines.
- [COMMIT_GUIDELINES_EN.md](COMMIT_GUIDELINES_EN.md) *(planned)* — Commit writing rules.
- [PULL_REQUEST_PROCESS_EN.md](PULL_REQUEST_PROCESS_EN.md) *(planned)* — Pull request process.
